...
Процедура ПриСозданииОбъекта(
    &Параметр(ЗначениеПоУмолчанию = "Трррунь") Значение,
    &Параметр ОбязательныйПараметр,
)
...
// TODO: Про желудь РазворачивательАннотаций
