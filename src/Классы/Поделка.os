...
Процедура ПриСозданииОбъекта()
	...
	// Инициализация системных желудей, которые не могут проходить через полноценный цикл инициализации.
	// TODO: Добавить возможность инициализации системных желудей через аннотацию &ВремениИнициализации,
	// как &Заготовки? Поддержка инстанцирования во время инициализации вроде бы уже есть (в определении и фабрике).
	ФабрикаЖелудей.ДобавитьДуб(Тип("СлужебныйДубОсени"));
	ИнициализированныеЖелудиОдиночки.Вставить("РазворачивательАннотаций", РазворачивательАннотаций);
