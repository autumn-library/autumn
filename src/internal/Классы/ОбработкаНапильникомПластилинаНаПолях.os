...
Процедура ОбработатьАннотацию(ИмяАннотации, Желудь, ОпределениеЖелудя)
	...
	Для Каждого Свойство Из Свойства Цикл
		...
		ПрилепляемаяЧастица = ПрилеплениеЧастиц.НайтиПрилепляемуюЧастицу(_Поделка, _УправляющийПрилепляемымиКоллекциями, ДанныеОПрилепляемойЧастице);
...
&Напильник
&Порядок(0)
Процедура ПриСозданииОбъекта(&Пластилин Поделка, &Пластилин УправляющийПрилепляемымиКоллекциями)
	_Поделка = Поделка;
