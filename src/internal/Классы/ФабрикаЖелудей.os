...
Функция ДобавитьДуб(ТипДуба) Экспорт
	...
	Для Каждого МетодЗавязи Из МетодыЗавязи Цикл
		...
		ИмяЖелудя = ЧитательАннотаций.ПрочитатьИмяЖелудя(МетодЗавязи.Аннотации, ИмяКорневойАннотации, МетодЗавязи.Имя);
		ТипЖелудя = ЧитательАннотаций.ПрочитатьТипЖелудя(МетодЗавязи, МетодЗавязи.Аннотации);
