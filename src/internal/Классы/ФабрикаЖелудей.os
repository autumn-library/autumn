...
Функция НайтиЖелудь(ИмяЖелудя, ПрилепляемыеЧастицы) Экспорт
	...
	Иначе
		Если НЕ ОпределениеЖелудя.ВремениИнициализации() Тогда
			ДанныеНапильников = Поделка.НайтиЖелуди("Напильник", , "ТаблицаЗначений");
			Для Каждого ДанныеНапильника Из ДанныеНапильников Цикл
				
				ОпределениеНапильника = ДанныеНапильника.ОпределениеЖелудя;
				...
				Напильник = ДанныеНапильника.Желудь;
