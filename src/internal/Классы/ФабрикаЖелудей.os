...
Функция ДобавитьДуб(ТипДуба) Экспорт
	...
	Для Каждого МетодЗавязи Из МетодыЗавязи Цикл
		...
		РазворачивательАннотаций.РазвернутьАннотацииСвойства(МетодЗавязи, ТипДуба);
...
Функция ДобавитьАннотацию(ТипАннотации) Экспорт
	...
	ОпределениеАннотации = Новый ОпределениеАннотации(ИмяАннотации, ИмяТипаАннотации, ТипЖителяЛеса, Параметры, Аннотации);
