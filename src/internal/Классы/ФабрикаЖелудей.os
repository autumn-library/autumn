...
// Таблица, в которой хранятся все определения рогаток:
//   * Имя - Строка - имя рогатки;
//   * ОпределениеРогатки - ОпределениеЖелудя - описание рогатки.
Перем ОпределенияРогаток;
...
Функция ПолучитьОпределенияРогаток() Экспорт
	Возврат ОпределенияРогаток.Скопировать();
КонецФункции
...
Функция ДобавитьРогатку(ТипРогатки) Экспорт
	...
	НоваяРогатка = ОпределенияРогаток.Добавить();
	НоваяРогатка.Имя = ОпределениеРогатки.Имя();
	НоваяРогатка.ОпределениеРогатки = ОпределениеРогатки;
...
Процедура ПриСозданииОбъекта(пПоделка, пРазворачивательАннотаций)
	...
	ОпределенияРогаток = Новый ТаблицаЗначений();
	ОпределенияРогаток.Колонки.Добавить("Имя", Новый ОписаниеТипов("Строка"));
	ОпределенияРогаток.Колонки.Добавить("ОпределениеРогатки");

	ОпределенияРогаток.Индексы.Добавить("Имя");
