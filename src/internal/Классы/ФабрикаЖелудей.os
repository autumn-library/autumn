...
Функция ДобавитьДуб(ТипДуба) Экспорт
	...
	Для Каждого МетодЗавязи Из МетодыЗавязи Цикл
		...
		РазвернутьАннотации(МетодЗавязи.Аннотации, Аннотации, ТипДуба);
...
Функция ДобавитьЖителяЛеса(ТипЖителяЛеса, ИмяЖителяЛеса, АннотацияНадКонструктором)
	...
	Для Каждого Метод Из Методы Цикл
		...
		РазвернутьАннотации(Метод.Аннотации, Аннотации, ТипЖителяЛеса);
...
Процедура РазвернутьАннотации(Аннотации, НакопленныеАннотации, ИмяТипаАннотации)
	...
	Для Каждого Аннотация Из Аннотации Цикл
		...
		// TODO: Нужно ли вообще проверять подчиненные аннотации? Они же проверены при регистрации аннотации.
		// TODO: кэширование развернутых аннотаций?
		...
		Если НРег(Аннотация.Имя) <> НРег("Аннотация") Тогда
			РазвернутьАннотации(ОпределениеАннотации.Аннотации, НакопленныеАннотации, ИмяТипаАннотации);
			Продолжить;
		КонецЕсли;
