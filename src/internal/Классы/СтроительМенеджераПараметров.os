...
//
// Дефолтный состав, который заводит конструктор:
...
//
// Провайдера inline (ПровайдерПараметровСоответствие, приоритет 3) в этом составе нет:
// его заводит СоветДругогоМастера при первом вызове устаревшего сеттера ЗначенияДеталек,
// а прикладной код - вызовом ДобавитьПровайдерСоответствие.
//
