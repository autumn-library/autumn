...
// Используется Поделкой для последующего вызова МенеджерПараметров.Прочитать().
//
...
//
Функция ДобавитьПровайдерСоответствие(Знач Значения = Неопределено,
                                      Знач Приоритет = Неопределено,
                                      Знач Идентификатор = Неопределено) Экспорт
