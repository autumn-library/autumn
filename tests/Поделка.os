...
&Тест
Процедура ПластилинВнедряетсяВЗавязьСоСпецификациейИнициализация() Экспорт
	...
	Поделка.ДобавитьЗавязь("&Завязь(""ИнициализационнаяЗавязь"", Тип = ""Строка"") &Спецификация(""Инициализация"") () -> Возврат ""Привет""");
	Поделка.ДобавитьЗавязь("
	|	&Завязь(""ЗавязьСПластилиномИнициализации"", Тип = ""Строка"") &Спецификация(""Инициализация"") (&Пластилин ИнициализационнаяЗавязь) -> 
	|		Возврат ИнициализационнаяЗавязь + "" мир"""
	);
	...
	Ожидаем.Что(Поделка.НайтиЖелудь("ЗавязьСПластилиномИнициализации"))
		.Равно("Привет мир");
