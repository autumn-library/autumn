...
&Тест
Процедура ПоискТабакеркиПоИмени() Экспорт
	...
	// Когда
	Табакерка = Поделка.НайтиТабакерку("ТестовыйЖелудь");
	ТестовыйЖелудь = Поделка.НайтиЖелудь("ТестовыйЖелудь");

	// Тогда
	Ожидаем.Что(Табакерка.Достать(), "Табакерка содержит нужный желудь")
		.Равно(ТестовыйЖелудь);
