...
// Документированный публичный метод: библиотеки экосистемы забирают через него
// настоящий МенеджерПараметров configor, чтобы работать с полным интерфейсом
// менеджера, а не с урезанным набором методов строителя.
&Тест
Процедура МенеджерПараметровОтдаетМенеджерConfigor() Экспорт
