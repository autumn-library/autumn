...
Процедура ЖелудьРегистрируетсяПодИменемИзАннотации() Экспорт
	...
	КонтекстПриложения = Новый КонтекстПриложения();
	КонтекстПриложения
		.ЗарегистрироватьЖелудь(Тип("Желудь1"))
		.ЗапуститьПриложение();
...
Процедура ВерховныйЖелудьМожетПереопределитьОбычный() Экспорт
	...
	КонтекстПриложения
		.ЗарегистрироватьЖелудь(Тип("Желудь1"))
		.ЗарегистрироватьЖелудь(Тип("ВерховныйТестовыйЖелудь"))
		.ЗапуститьПриложение();
...
Процедура ДвухВерховныхЖелудейБытьНеМожет() Экспорт
	...
	// Дано
	КонтекстПриложения = Новый КонтекстПриложения();
	КонтекстПриложения.ЗарегистрироватьЖелудь(Тип("ВерховныйТестовыйЖелудь"));
...
Процедура УЖелудяМожетБытьНесколькоПрозвищ() Экспорт
	...
	// Когда
	Желудь1 = КонтекстПриложения.ПолучитьЖелудь("Кругляш");
	Желудь2 = КонтекстПриложения.ПолучитьЖелудь("Мелкий");
...
Процедура МассивЖелудейМожноВнедритьЧерезПластилин() Экспорт
	...
	КонтекстПриложения
		...
		.ЗарегистрироватьЖелудь(Тип("ЖелудьНижнегоУровня"))
		.ЗарегистрироватьЖелудь(Тип("Желудь1"))
		.ЗарегистрироватьЖелудь(Тип("Желудь3"))
		.ЗапуститьПриложение();
...
Процедура ЖелудьНаполняетсяДетальками() Экспорт
	...
	КонтекстПриложения = Новый КонтекстПриложения();
	КонтекстПриложения
		.ЗарегистрироватьЖелудь(Тип("ЖелудьСНастройками"))
		.ЗапуститьПриложение();
